...
public sealed class AppSettings
{
    ...
    /// <summary>
    /// عرض لوحة أوامر المشروع الطافية (بكسل مستقلّ عن الجهاز). يضبطه المستخدم بسحب حافّتها اليمنى
    /// ويبقى بين التشغيلات — أوامر بعض المشاريع طويلة ولا تُقرأ في العرض الافتراضيّ.
    /// </summary>
    public double QuickDockWidth { get; set; } = 234;
