...
public static class Loc
{
    ...
    private static readonly Dictionary<string, (string Ar, string En)> Table = new()
    {
        ...
        ["bg.slideshow.enable"]     = ("تبديل الخلفيّة تلقائيّاً من صور مجلّد", "Automatically rotate background from a folder"),
        ["bg.slideshow.chooseFolder"] = ("اختر مجلّداً", "Choose folder"),
        ["bg.slideshow.clearFolder"]  = ("إزالة", "Remove"),
        ["bg.slideshow.empty"]      = ("لا صور في هذا المجلّد", "No images found in this folder"),
        ["bg.slideshow.transition"] = ("نوع الحركة", "Transition"),
        ["bg.slideshow.interval"]   = ("مدّة كلّ صورة (دقائق)", "Minutes per image"),
        ["bg.slideshow.shuffle"]    = ("ترتيب عشوائيّ", "Shuffle order"),
        ["bg.slideshow.tr.fade"]      = ("تلاشٍ", "Fade"),
        ["bg.slideshow.tr.fadeBlack"] = ("تلاشٍ عبر الأسود", "Fade through black"),
        ["bg.slideshow.tr.slide"]     = ("تنقّل", "Slide"),
        ["bg.slideshow.tr.zoom"]      = ("تكبير", "Zoom"),
        ["bg.slideshow.tr.none"]      = ("بلا حركة", "Instant"),
        ...
        // حالة التنفيذ في شريط أدوات التيرمنال — كانت نصوصاً عربيّة ثابتة في الكود.
        ["term.st.running"]    = ("يعمل", "Running"),
        ["term.st.done"]       = ("انتهى", "Done"),
        ["term.st.failed"]     = ("فشل", "Failed"),
        ["term.st.stopped"]    = ("أُوقف", "Stopped"),
        ["term.st.error"]      = ("خطأ", "Error"),
        ["term.st.ended"]      = ("الجلسة منتهية — اضغط إعادة التشغيل", "Session ended — press Restart"),
        ["term.st.exit"]       = ("رمز", "exit"),
        ["term.history"]       = ("سجلّ الأوامر", "Command history"),
        ["term.expand"]        = ("توسيع مساحة العمل", "Expand the workspace"),
        ["term.collapse"]      = ("إرجاع الشريط الجانبيّ", "Restore the sidebar"),
        ["term.detach"]        = ("فتح في نافذة مستقلّة · Shift: تيرمنال خارجيّ بنفس المسار",
                                  "Open in a separate window · Shift: external terminal at the same path"),
        ["term.send"]          = ("تنفيذ الأمر (Enter)", "Run the command (Enter)"),
        ...
        ["ai.cmp.hintProgram"] = ("البرنامج ينتظر مفاتيحك — الأسهم و Enter تذهب إليه",
                                  "The program is reading keys — arrows and Enter go to it"),
